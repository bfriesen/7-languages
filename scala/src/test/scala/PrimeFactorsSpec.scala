...
class PrimeFactorsSpec extends FlatSpec with Matchers {
  ...
  it should "give factors of 10 as [2, 5]" in {
    PrimeFactors.factors(10) should equal (List(2, 5))
  }
  
  it should "give factors of 11 as [11]" in {
    PrimeFactors.factors(11) should equal (List(11))
  }
  
  it should "give factors of 12 as [2, 2, 3]" in {
    PrimeFactors.factors(12) should equal (List(2, 2, 3))
  }
  
  it should "give factors of 15 as [3, 5]" in {
    PrimeFactors.factors(15) should equal (List(3, 5))
  }
}
